...
//	private InfoWindow mInfoWindow;
    ...
    BitmapDescriptor bdA = BitmapDescriptorFactory.fromResource(R.drawable.start_x);//start_x
    BitmapDescriptor bdB = BitmapDescriptorFactory.fromResource(R.drawable.end_x);//ic_end_poi_icon
...
//                            mCarInfoGPS.setGpstime(dataObj.get("gpstime").getAsString());//carstatus
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Log.i("TrackFragment", t.getMessage());
            }
        });
    }
