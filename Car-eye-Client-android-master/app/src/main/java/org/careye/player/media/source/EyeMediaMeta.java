...
public class EyeMediaMeta {
    // media meta
    public static final String EYEM_KEY_FORMAT = "format";
    public static final String EYEM_KEY_DURATION_US = "duration_us";
    public static final String EYEM_KEY_START_US = "start_us";
    public static final String EYEM_KEY_BITRATE = "bitrate";
    public static final String EYEM_KEY_VIDEO_STREAM = "video";
    public static final String EYEM_KEY_AUDIO_STREAM = "audio";
    public static final String EYEM_KEY_TIMEDTEXT_STREAM = "timedtext";

    // stream meta
    public static final String EYEM_KEY_TYPE = "type";
    public static final String EYEM_VAL_TYPE__VIDEO = "video";
    public static final String EYEM_VAL_TYPE__AUDIO = "audio";
    public static final String EYEM_VAL_TYPE__TIMEDTEXT = "timedtext";
    public static final String EYEM_VAL_TYPE__UNKNOWN = "unknown";
    public static final String EYEM_KEY_LANGUAGE = "language";

    public static final String EYEM_KEY_CODEC_NAME = "codec_name";
    public static final String EYEM_KEY_CODEC_PROFILE = "codec_profile";
    public static final String EYEM_KEY_CODEC_LEVEL = "codec_level";
    public static final String EYEM_KEY_CODEC_LONG_NAME = "codec_long_name";
    public static final String EYEM_KEY_CODEC_PIXEL_FORMAT = "codec_pixel_format";
    public static final String EYEM_KEY_CODEC_PROFILE_ID = "codec_profile_id";

    // stream: video
    public static final String EYEM_KEY_WIDTH = "width";
    public static final String EYEM_KEY_HEIGHT = "height";
    public static final String EYEM_KEY_FPS_NUM = "fps_num";
    public static final String EYEM_KEY_FPS_DEN = "fps_den";
    public static final String EYEM_KEY_TBR_NUM = "tbr_num";
    public static final String EYEM_KEY_TBR_DEN = "tbr_den";
    public static final String EYEM_KEY_SAR_NUM = "sar_num";
    public static final String EYEM_KEY_SAR_DEN = "sar_den";
    // stream: audio
    public static final String EYEM_KEY_SAMPLE_RATE = "sample_rate";
    public static final String EYEM_KEY_CHANNEL_LAYOUT = "channel_layout";

    public static final String EYEM_KEY_STREAMS = "streams";
    ...
    public final ArrayList<EyeStreamMeta> mStreams = new ArrayList<EyeStreamMeta>();
    public EyeStreamMeta mVideoStream;
    public EyeStreamMeta mAudioStream;
    ...
    public static EyeMediaMeta parse(Bundle mediaMeta) {
        if (mediaMeta == null)
            return null;

        EyeMediaMeta meta = new EyeMediaMeta();
        meta.mMediaMeta = mediaMeta;

        meta.mFormat = meta.getString(EYEM_KEY_FORMAT);
        meta.mDurationUS = meta.getLong(EYEM_KEY_DURATION_US);
        meta.mStartUS = meta.getLong(EYEM_KEY_START_US);
        meta.mBitrate = meta.getLong(EYEM_KEY_BITRATE);

        int videoStreamIndex = meta.getInt(EYEM_KEY_VIDEO_STREAM, -1);
        int audioStreamIndex = meta.getInt(EYEM_KEY_AUDIO_STREAM, -1);
        int subtitleStreamIndex = meta.getInt(EYEM_KEY_TIMEDTEXT_STREAM, -1);

        ArrayList<Bundle> streams = meta
                .getParcelableArrayList(EYEM_KEY_STREAMS);
        if (streams == null)
            return meta;
        ...
        for (Bundle streamBundle : streams) {
            ...
            EyeStreamMeta streamMeta = new EyeStreamMeta(index);
            streamMeta.mMeta = streamBundle;
            streamMeta.mType = streamMeta.getString(EYEM_KEY_TYPE);
            streamMeta.mLanguage = streamMeta.getString(EYEM_KEY_LANGUAGE);
            if (TextUtils.isEmpty(streamMeta.mType))
                continue;

            streamMeta.mCodecName = streamMeta.getString(EYEM_KEY_CODEC_NAME);
            streamMeta.mCodecProfile = streamMeta
                    .getString(EYEM_KEY_CODEC_PROFILE);
            streamMeta.mCodecLongName = streamMeta
                    .getString(EYEM_KEY_CODEC_LONG_NAME);
            streamMeta.mBitrate = streamMeta.getInt(EYEM_KEY_BITRATE);

            if (streamMeta.mType.equalsIgnoreCase(EYEM_VAL_TYPE__VIDEO)) {
                streamMeta.mWidth = streamMeta.getInt(EYEM_KEY_WIDTH);
                streamMeta.mHeight = streamMeta.getInt(EYEM_KEY_HEIGHT);
                streamMeta.mFpsNum = streamMeta.getInt(EYEM_KEY_FPS_NUM);
                streamMeta.mFpsDen = streamMeta.getInt(EYEM_KEY_FPS_DEN);
                streamMeta.mTbrNum = streamMeta.getInt(EYEM_KEY_TBR_NUM);
                streamMeta.mTbrDen = streamMeta.getInt(EYEM_KEY_TBR_DEN);
                streamMeta.mSarNum = streamMeta.getInt(EYEM_KEY_SAR_NUM);
                streamMeta.mSarDen = streamMeta.getInt(EYEM_KEY_SAR_DEN);

                if (videoStreamIndex == index) {
                    meta.mVideoStream = streamMeta;
                }
            } else if (streamMeta.mType.equalsIgnoreCase(EYEM_VAL_TYPE__AUDIO)) {
                streamMeta.mSampleRate = streamMeta
                        .getInt(EYEM_KEY_SAMPLE_RATE);
                streamMeta.mChannelLayout = streamMeta
                        .getLong(EYEM_KEY_CHANNEL_LAYOUT);
    ...
    public static class EyeStreamMeta {
        public Bundle mMeta;
        ...
        public EyeStreamMeta(int index) {
            mIndex = index;
        }
