...
public class EyeMediaCodecInfo {
    private final static String TAG = "EyeMediaCodecInfo";
    ...
    public static EyeMediaCodecInfo setupCandidate(MediaCodecInfo codecInfo,
                                                   String mimeType) {
        if (codecInfo == null
        ...
        EyeMediaCodecInfo candidate = new EyeMediaCodecInfo();
